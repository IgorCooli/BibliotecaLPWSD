...
import br.cesjf.bibliotecalpwsd.util.strategy.PrazoCircularFuncionario;
import br.cesjf.bibliotecalpwsd.util.strategy.PrazoCircularOutrosUsuarios;
import br.cesjf.bibliotecalpwsd.util.strategy.PrazoNaoCircular;
    ...
    public void calculaDevolucaoPrevista() {
        ...
        if(dataEmprestimo != null){
            ...
            if(idExemplar.getCircular() && idUsuario.getTipo().equals('C')){
                ...
                c = new PrazoCircularFuncionario().calculaDevolucao(dataEmprestimo);
                
            } else if(idExemplar.getCircular() && !idUsuario.getTipo().equals('C')){
                
                c = new PrazoCircularOutrosUsuarios().calculaDevolucao(dataEmprestimo);
                
            } else if(!idExemplar.getCircular()) {
                
                c = new PrazoNaoCircular().calculaDevolucao(dataEmprestimo);
